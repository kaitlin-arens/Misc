...
public class Calculator
{
  ...
  public String infixToPostfix(String infixNotation)
  {
     ...
     String token;
     String postfix = "";
     //System.out.println("You entered: " + infixNotation.toString());
	...
	// 2. If the token is a number, then add it to the postfix expression.
      if(!infixString.isOperator(token))
      {
        ...
        //System.out.println("Postfix Step 2: " + postfix);
        continue;
      }
	...
	//    push the token onto the stack
     ...
     {
       stack.push(token);
       System.out.println("Stack Step 3: " + stack.toString());
       continue;
     }
   ...
   while(!stack.isEmpty())
   {
     postfix = postfix + stack.pop() + " ";
      ...
      System.out.println("End of infixToPostfix: " + postfix);
